      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
           <a href="m_survey_form.php?act=tambah" class="btn btn-sm btn-primary">Tambah Data Survey</a>
          </div>
        </div>
        <div class="card-body">
              ...
              <?php 
                ...
                while($row = $list->fetch_assoc()){
                  echo '<tr>
                      ...
                      <td>
                        <a title="Edit Data" href="m_survey_form.php?act=edit&id='.$row['survey_id'].'" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                        <a onclick="return confirm(\'Apakah anda yakin menghapus data ini?\')" title="Hapus Data" href="m_survey_action.php?act=hapus&id='.$row['survey_id'].'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                      </td>
