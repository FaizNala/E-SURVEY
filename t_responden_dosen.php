          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Respon Dosen</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <?php 
                ...
                while($row = $list->fetch_assoc()){
                  echo '<tr>
                      ...
                      <td>
                        <a title="Jawaban" href="t_jawaban_dosen?act=show&id='.$row['responden_dosen_id'].'" class="btn btn-primary btn-sm"><i class="fas fa-poll"></i></a>
