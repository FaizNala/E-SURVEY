...
<body>
    <div class="container">
        ...
        <div class="links">
            <a href="link_mahasiswa.php" class="link">Mahasiswa</a>
            <a href="link_dosen.php" class="link">Dosen</a>
            <a href="link_tendik.php" class="link">Tendik</a>
            <a href="link_ortu.php" class="link">Orang Tua</a>
            <a href="link_alumni.php" class="link">Alumni</a>
            <a href="link_industri.php" class="link">Industri</a>
        </div>
    </div>
</body>
