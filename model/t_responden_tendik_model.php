...
class t_responden_tendik{
    ...
    public function insertData($data){
        ...
        $query = $this->db->prepare("INSERT INTO {$this->table} (responden_tanggal, responden_nopeg, responden_nama, responden_unit) VALUES (?, ?, ?, ?)");

        // binding parameter ke query, "s" berarti string, "ssss" berarti empat string
        $query->bind_param('ssss', $data['responden_tanggal'], $data['responden_nopeg'], $data['responden_nama'], $data['responden_unit']);
